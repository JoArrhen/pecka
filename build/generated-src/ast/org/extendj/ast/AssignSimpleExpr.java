...
/**
 * @ast node
 * @declaredat /Users/johanarrhen/Git/ProgramAnalysis/pecka/extendj/java4/grammar/Java.ast:227
 * @astdecl AssignSimpleExpr : AssignExpr ::= Dest:Expr Source:Expr;
 * @production AssignSimpleExpr : {@link AssignExpr};

 */
public class AssignSimpleExpr extends AssignExpr implements Cloneable, DeclarationSite {
  /**
   ...
   * @declaredat /Users/johanarrhen/Git/ProgramAnalysis/pecka/extendj/java4/frontend/PrettyPrintUtil.jrag:384
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
   ...
   * @attribute syn
   * @aspect PointsTo
   * @declaredat /Users/johanarrhen/Git/ProgramAnalysis/pecka/src/main/jastadd/algorithm/Andersen.jrag:67
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="PointsTo", declaredAt="/Users/johanarrhen/Git/ProgramAnalysis/pecka/src/main/jastadd/algorithm/Andersen.jrag:67")
   ...
   * @attribute syn
   * @aspect Utilities
   * @declaredat /Users/johanarrhen/Git/ProgramAnalysis/pecka/src/main/jastadd/algorithm/Andersen.jrag:310
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  ...
  public DeclarationSite getDeclaration() {
    DeclarationSite getDeclaration_value = getSource().getDeclaration();
   ...
   * @declaredat /Users/johanarrhen/Git/ProgramAnalysis/pecka/extendj/java7/frontend/SuppressWarnings.jrag:36
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.INH)
  @ASTNodeAnnotation.Source(aspect="SuppressWarnings", declaredAt="/Users/johanarrhen/Git/ProgramAnalysis/pecka/extendj/java7/frontend/SuppressWarnings.jrag:36")
  ...
  public boolean Define_isDest(ASTNode _callerNode, ASTNode _childNode) {
    if (getDestNoTransform() != null && _callerNode == getDest()) {
      // @declaredat /Users/johanarrhen/Git/ProgramAnalysis/pecka/extendj/java4/frontend/DefiniteAssignment.jrag:36
      return true;
    }
    else {
  ...
  public boolean Define_isSource(ASTNode _callerNode, ASTNode _childNode) {
    if (getDestNoTransform() != null && _callerNode == getDest()) {
      // @declaredat /Users/johanarrhen/Git/ProgramAnalysis/pecka/extendj/java4/frontend/DefiniteAssignment.jrag:46
      return false;
    }
    else {
  ...
  public TypeDecl Define_assignConvertedType(ASTNode _callerNode, ASTNode _childNode) {
    if (getSourceNoTransform() != null && _callerNode == getSource()) {
      // @declaredat /Users/johanarrhen/Git/ProgramAnalysis/pecka/extendj/java5/frontend/AssignConvertedType.jrag:48
      return getDest().type();
    }
    else {
  ...
  protected void collect_contributors_CompilationUnit_problems(CompilationUnit _root, java.util.Map<ASTNode, java.util.Set<ASTNode>> _map) {
    // @declaredat /Users/johanarrhen/Git/ProgramAnalysis/pecka/extendj/java7/frontend/UncheckedConversion.jrag:51
  ...
  protected void collect_contributors_InvocationTarget_inclusionEdges(ASTNode _root, java.util.Map<ASTNode, java.util.Set<ASTNode>> _map) {
    // @declaredat /Users/johanarrhen/Git/ProgramAnalysis/pecka/src/main/jastadd/algorithm/Andersen.jrag:97
    if (getSource().hasDeclaration() && getDest().hasDeclaration()) {
  ...
  protected void contributeTo_InvocationTarget_inclusionEdges(Set<InclusionEdge> collection) {
    ...
    if (getSource().hasDeclaration() && getDest().hasDeclaration()) {
      collection.add(new InclusionEdge(getSource().getDeclaration(), getDest().getDeclaration()));
    }
  }
