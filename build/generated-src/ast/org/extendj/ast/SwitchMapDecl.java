...
import java.io.File;
/**
 * Enum SwitchMap, implicitly generated anonymous class for switch statement with
 * enum argument type.
 * @ast node
 * @declaredat /Users/johanarrhen/Git/ProgramAnalysis/pecka/extendj/java5/grammar/Enums.ast:14
 * @astdecl SwitchMapDecl : AnonymousDecl ::= Modifiers <ID:String> BodyDecl* [ImplicitConstructor:ConstructorDecl] [SuperClass:Access] Implements:Access*;
 * @production SwitchMapDecl : {@link AnonymousDecl};

 */
public class SwitchMapDecl extends AnonymousDecl implements Cloneable {
  /**
   * @declaredat ASTNode:1
   */
  public SwitchMapDecl() {
    super();
  }
  /**
  ...
  public SwitchMapDecl(Modifiers p0, String p1, List<BodyDecl> p2) {
    setChild(p0, 0);
    setID(p1);
    setChild(p2, 1);
  }
   ...
   */
  public SwitchMapDecl(Modifiers p0, beaver.Symbol p1, List<BodyDecl> p2) {
    setChild(p0, 0);
    setID(p1);
    setChild(p2, 1);
  }
   ...
   */
  public SwitchMapDecl clone() throws CloneNotSupportedException {
    SwitchMapDecl node = (SwitchMapDecl) super.clone();
    return node;
  }
  /** @apilevel internal 
   * @declaredat ASTNode:58
   */
  public SwitchMapDecl copy() {
    try {
      SwitchMapDecl node = (SwitchMapDecl) clone();
      node.parent = null;
      if (children != null) {
   ...
   */
  public SwitchMapDecl treeCopyNoTransform() {
    SwitchMapDecl tree = (SwitchMapDecl) copy();
    if (children != null) {
   ...
   * @apilevel high-level
   */
  public SwitchMapDecl setModifiers(Modifiers node) {
    setChild(node, 0);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public SwitchMapDecl setID(String value) {
   ...
   * @apilevel internal
   */
  public SwitchMapDecl setID(beaver.Symbol symbol) {
   ...
   * @apilevel high-level
   */
  public SwitchMapDecl setBodyDeclList(List<BodyDecl> list) {
    setChild(list, 1);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public SwitchMapDecl addBodyDecl(BodyDecl node) {
  ...
  /** @apilevel low-level 
   */
  public SwitchMapDecl addBodyDeclNoTransform(BodyDecl node) {
   ...
   * @apilevel high-level
   */
  public SwitchMapDecl setBodyDecl(BodyDecl node, int i) {
   ...
   * @apilevel high-level
   */
  public SwitchMapDecl setImplicitConstructor(ConstructorDecl node) {
   ...
   * @apilevel internal
   */
  public SwitchMapDecl setSuperClassOpt(Opt<Access> node) {
    throw new Error("Can not replace NTA child SuperClassOpt in SwitchMapDecl!");
  }
  /**
   ...
   * @apilevel high-level
   */
  public SwitchMapDecl setSuperClass(Access node) {
   ...
   * @apilevel internal
   */
  public SwitchMapDecl setImplementsList(List<Access> node) {
    throw new Error("Can not replace NTA child ImplementsList in SwitchMapDecl!");
  }
  /**
   ...
   * @apilevel high-level
   */
  public SwitchMapDecl addImplements(Access node) {
  ...
  /** @apilevel low-level 
   */
  public SwitchMapDecl addImplementsNoTransform(Access node) {
   ...
   * @apilevel high-level
   */
  public SwitchMapDecl setImplements(Access node, int i) {
