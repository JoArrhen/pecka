...
public class AllMethodsAction implements Action {
  ...
  public AllMethodsAction(Options options) {
  ...
  public int execute() {
    ...
    try {
      ...
      for (InvocationTarget method : methods) {
        ...
        for (Map.Entry<String, List<String>> entry : method.parameterPointers().entrySet()) {
